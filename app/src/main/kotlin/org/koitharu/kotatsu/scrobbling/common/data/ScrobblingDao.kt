...
abstract class ScrobblingDao {
	...
	@Query("SELECT manga_id FROM scrobblings WHERE scrobbler = :scrobbler AND target_id = :targetId LIMIT 1")
	abstract suspend fun findMangaIdByTarget(scrobbler: Int, targetId: Long): Long?
