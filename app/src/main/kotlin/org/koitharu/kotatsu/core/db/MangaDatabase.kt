...
import org.koitharu.kotatsu.core.db.dao.LnReaderSourcesDao
...
@Database(
	entities = [
		...
		MangaSourceEntity::class, StatsEntity::class, LocalMangaIndexEntity::class, LnReaderSourceEntity::class,
	],
...
abstract class MangaDatabase : RoomDatabase() {
	...
	abstract fun getLnReaderSourcesDao(): LnReaderSourcesDao
}
