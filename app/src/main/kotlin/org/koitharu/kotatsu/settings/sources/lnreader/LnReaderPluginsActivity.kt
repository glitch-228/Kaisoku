...
@AndroidEntryPoint
class LnReaderPluginsActivity : BaseActivity<ActivitySourcesCatalogBinding>(),
	OnListItemClickListener<LnReaderPluginListItem.Extension>,
	AppBarOwner,
	...
	private val viewModel by viewModels<LnReaderPluginsViewModel>()
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		supportActionBar?.title = intent.getStringExtra(org.koitharu.kotatsu.core.nav.AppRouter.KEY_TITLE)
			?: getString(R.string.lnreader_plugins)
		val adapter = LnReaderPluginsAdapter(this)
		...
		addMenuProvider(object : MenuProvider {
			override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
				...
				searchView.setOnQueryTextListener(this@LnReaderPluginsActivity)
	...
	override fun onItemClick(item: LnReaderPluginListItem.Extension, view: View) {
		viewModel.onPluginClick(item.descriptor)
	}
