...
-dontwarn okio.**
-dontwarn okhttp3.**
# OkHttp's zstd support is loaded by hosted Mihon extensions through the shared
# classloader, so R8 cannot see its call sites. Keep the decoder bridge in releases.
